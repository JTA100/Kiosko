...
public class EquipoDeFutbolTest {
	...
	public void queElEquipoPresenteLosJugadoresOrdenadosPorNombre() throws CapacidadMaximaException, JugadorDuplicadoException, JugadoreInexistenteException{
		...
		argentina.agregarJugador(new Jugador(5, "Fernando Gago", 10000));
		argentina.agregarJugador(new Jugador(6, "Lucas Biglia", 10000));
		argentina.agregarJugador(new Jugador(7, "Angel Di Maria", 10000));
		argentina.agregarJugador(new Jugador(8, "Enzo Perez", 10000));
		argentina.agregarJugador(new Jugador(9, "Gonzalo Higuain", 10000));
		argentina.agregarJugador(new Jugador(10, "Lionel Messi", 10000));
		argentina.agregarJugador(new Jugador(11, "Maximiliano Rodriguez", 10000));
		argentina.agregarJugador(new Jugador(12, "Agustin Orion", 10000));
		argentina.agregarJugador(new Jugador(13, "Augusto Fernandez", 10000));
		argentina.agregarJugador(new Jugador(14, "Javier Mascherano", 10000));
		argentina.agregarJugador(new Jugador(15, "Martin Demichelis", 10000));
		argentina.agregarJugador(new Jugador(16, "Marcos Rojo", 10000));
		argentina.agregarJugador(new Jugador(17, "Federico Fernandez", 10000));
		argentina.agregarJugador(new Jugador(18, "Rodrigo Palacio", 10000));
		argentina.agregarJugador(new Jugador(19, "Ricardo alvarez", 10000));
		argentina.agregarJugador(new Jugador(20, "Sergio Aguero", 10000));
		argentina.agregarJugador(new Jugador(21, "Mariano Andujar", 10000));
		argentina.agregarJugador(new Jugador(22, "Ezequiel Lavezzi", 10000));
		argentina.agregarJugador(new Jugador(23, "Jose Basanta", 10000));
		
		Iterator<Jugador> it = argentina.devolverPlanteOrdenadoPorNombreDeJugador().iterator();
		
		Jugador primero = it.next();
		
		assertEquals("Agustin Orion", primero.getNombre());
